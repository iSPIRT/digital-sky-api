...
public class AuthenticationController {
    ...
    @PreAuthorize("hasRole('ADMIN') or hasRole('ATC_ADMIN') or hasRole('AFMLU_ADMIN') or hasRole('VIEWER_ADMIN') or hasRole('ATC_VIEWER_ADMIN') or hasRole('AFMLU_VIEWER_ADMIN')")
