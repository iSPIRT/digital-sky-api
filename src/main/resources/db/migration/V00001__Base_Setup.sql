...
CREATE TABLE ds_occurrence_report (
    ID INT AUTO_INCREMENT PRIMARY KEY,
    OPERATOR_DRONE_ID INT,
    OCCURRENCE_TIMESTAMP TIMESTAMP,
    PLACE_OF_OCCURRENCE VARCHAR(200),
    OCCURRENCE_LATITUDE VARCHAR(20),
    OCCURRENCE_LONGITUDE VARCHAR(20),
    PHASE_OF_FLIGHT VARCHAR(20),
    TYPE_OF_OPERATION VARCHAR(30),
    COLOR_OF_RPA VARCHAR(30),
    RPA_DAMAGE_DETAILS VARCHAR(300),
    PROPERTY_DAMAGE_DETAILS VARCHAR(300),
    DETAILS_OF_INJURY VARCHAR(500),
    DETAILS_OF_PILOT VARCHAR(200),
    UAOP_NUMBER VARCHAR(50),
    OCCURRENCE_DESCRIPTION VARCHAR(500),
    DISTANCE_FROM_AIRCRAFT VARCHAR(20),
    DISTANCE_FROM_HELIPAD VARCHAR(20),
    PROXIMITY_FROM_DANGER_ZONE VARCHAR(100),
    CREATED_BY_ID INT,
    CREATED_TIMESTAMP TIMESTAMP,
    FOREIGN KEY (OPERATOR_DRONE_ID) REFERENCES ds_operator_drone(ID)
);
