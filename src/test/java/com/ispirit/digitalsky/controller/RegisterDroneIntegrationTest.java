...
public class RegisterDroneIntegrationTest {
    ...
    private final String keyStorePath = "/Users/archana/digitalsky.jks";
    ...
    public void registerDrone()  {
        ...
        mockDrone.setDeviceId("Beebop 7.0");
        ...
        String certificate = CertificateUtil.getBase64EncodedCertificate();
        ...
        ResponseEntity<RegisterDroneResponsePayload> responseEntity =
                restTemplate.postForEntity("/api/droneDevice/register/11",  mockDronePayload, RegisterDroneResponsePayload.class);
    ...
    public void deregisterDrone()  {
        ...
        RegisterDroneResponsePayload responsePayload =
                patchRestTemplate.patchForObject("/api/droneDevice/deregister/11", mockDronePayload, RegisterDroneResponsePayload.class);
